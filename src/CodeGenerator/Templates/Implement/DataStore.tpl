...
public class ${EntityName}DataStore : DataStoreBase<${DbContextName}, ${EntityName}, ${EntityName}AddDto, ${EntityName}UpdateDto, ${EntityName}Filter, ${EntityName}ItemDto>
{
    ...
    public override Task<${EntityName}> AddAsync(${EntityName}AddDto data) => base.AddAsync(data);
